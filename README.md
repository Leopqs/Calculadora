...
Requisitos funcionais:
  ...
  A calculadora deverá realizar todas as operações básicas (soma, subtração, multiplicação e divisão) pelo menos uma vez e ir atualizando seu valor com base nas operações realizadas.
